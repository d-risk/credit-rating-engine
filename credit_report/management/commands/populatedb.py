...
from credit_report.management.commands.randomize import random_risk_drivers
from credit_report.models import Company, Unit, FinancialsReport
...
class Command(BaseCommand):
    ...
    def add_arguments(self, parser):
        ...
        parser.add_argument('--import', action='', nargs=1, type=str, dest='import', )

    def handle(self, *args, **options):
        parse('financial-reports.csv')
